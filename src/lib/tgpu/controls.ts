...
// export function ctrl<const T extends Record<string, unknown>>(controls: {
//   [Key in keyof T]:
//     | false // short-circuit controls
//     | SelectControlParam<
//         T[Key] extends readonly string[] | readonly number[] ? T[Key] : T[Key] extends string[] ? string[] : number[]
//       >
//     | ToggleControlParam
//     | SliderControlParam
